# Project 4 - *MySimpleTwitter*

**Maggie** is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
GIF created with [LiceCap](LiceCap](http://www.cockos.com/licecap/).
...
## License
    ...
    Copyright [2017] [Maggie of copyright owner]
